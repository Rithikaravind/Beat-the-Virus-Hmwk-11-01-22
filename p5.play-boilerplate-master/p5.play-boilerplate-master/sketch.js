...
function draw() {
  ...
  if(boy.isTouching(virus)){
    ...
    swal({
      ...
      imageUrl:
      "https://media.istockphoto.com/vectors/evil-virus-vector-id1214442141?k=20&m=1214442141&s=170667a&w=0&h=ZU-XrtLYP3MVMx7D0qGpiVDPsgVwIwUpdKBbr001Tuo=",
    imageSize: "100x100",
    confirmButtonText: "Ok"
    })
  }
